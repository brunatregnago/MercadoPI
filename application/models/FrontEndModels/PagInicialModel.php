...
class PagInicialModel extends CI_Model{
    ...
    public function getAll() {
        ...
        $this->db->select('tb_produto.*,tb_unidade_medida.medida, tb_medida_valor.medida_valor, tb_departamento.id_departamento, tb_departamento.nome_departamento as departamento');
        ...
        $this->db->order_by('cd_departamento');
