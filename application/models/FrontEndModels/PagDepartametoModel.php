...
class PagDepartametoModel extends CI_Model {

    public function getAll() {
        //nome da tabela no DB
        $this->db->select('tb_departamento.nome_departamento,tb_produto.*,tb_unidade_medida.medida,tb_medida_valor.medida_valor');
